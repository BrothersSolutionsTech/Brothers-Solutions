        ...
        >
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap flex-col lg:flex-row -mx-4 items-center mt-20">
              <div className="w-[350px] sm:w-[380px] lg:w-1/3 px-4 mb-8 lg:mb-0 hidden md:inline">
                <div className="p-8 bg-customDarkBg3 rounded-3xl">
                  ...
                  <p className="mt-4 mb-6 2xl:mb-10 text-gray-500 leading-loose text-left">
                    Estamos creando la infraestructura para ofrecer nuevos
                    servicios.
                  </p>
                  ...
                  <div
                    className="inline-block text-center py-2 px-4 w-full rounded-xl rounded-t-xl disabled custom-button-colored-disabled font-bold leading-loose mt-16"
              ...
              <div className="w-[350px] sm:w-[380px] lg:w-1/3 px-4 mb-8 lg:mb-0">
                <div className="px-8 py-8 bg-customDarkBg3 rounded-3xl">
                  ...
                  <p className="mt-8 mb-8 2xl:mb-12 text-gray-500 leading-loose text-left">
                    La mejor manera de proyectar tu marca.
                  </p>
                  <ul className="mb-14 text-white">
                    ...
                    <li className="mb-4 flex">
                      <CheckArrowIcon />
                      <span>Diseño personalizado y responsivo</span>
                    </li>
                    <li className="mb-4 flex">
                      <CheckArrowIcon />
                      <span>Links a todas tus redes</span>
                    </li>
                    <li className="mb-4 flex">
                      <CheckArrowIcon />
              ...
              <div className="w-[350px] sm:w-[380px] lg:w-1/3 px-4 mb-8 lg:mb-0">
                <div className="p-8 bg-customDarkBg3 rounded-3xl">
                  ...
                  <div
                    className="inline-block text-center py-2 px-4 w-full rounded-xl rounded-t-xl custom-button-colored-disabled font-bold leading-loose mt-16"
                    // onClick={() => setIsModalOpen(true)}
                  >
                    Contactanos
                  </div>
